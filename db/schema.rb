...
ActiveRecord::Schema.define(version: 2020_12_17_022418) do
  ...
  create_table "destination_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_destination_addresses_on_purchase_record_id"
  end
  ...
  add_foreign_key "destination_addresses", "purchase_records"
